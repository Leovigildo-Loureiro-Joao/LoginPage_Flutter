...
import 'package:loginpage/pages/add_password_screen.dart';
import 'package:loginpage/pages/settings_screen.dart';
import 'package:loginpage/pages/dashboard_screen.dart';
...
import 'package:loginpage/widget/passwordDelegate.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  // ✅ TELA DE LISTA DE SENHAS SIMPLIFICADA
  Widget _buildPasswordListScreen() {
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        slivers: [
          // ✅ APP BAR PERSONALIZADA COM BOTÃO DE PESQUISA
          SliverAppBar(
          ...
          // ✅ CONTADOR (AGORA SEM BARRA DE PESQUISA)
          SliverToBoxAdapter(
            child: Padding(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('Senha: ${EncryptionService.decrypt(item.encryptedPassword)}'), // ✅ CORRIGIDO: Mostrar senha descriptografada
            SizedBox(height: 10),
            Text(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              _copyPassword(item);
              Navigator.pop(context); // ✅ FECHAR DIALOGO APÓS COPIAR
            },
          ),
        ],
      ),
